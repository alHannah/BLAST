        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if( ($cur_page == 'team.php') ) {echo 'active';} ?>">
                        <a href="team.php">
                            <i class="fa fa-group"></i> <span>Team Management</span>
                        </a>
                    </li>
