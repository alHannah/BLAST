...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['region_name'])) {
    	...
    	$statement = $pdo->prepare("SELECT * FROM tbl_region WHERE region_name=?");
    	$statement->execute(array($_POST['region_name']));
    ...
    if($valid == 1) {
		...
		// Saving data into the main table tbl_region
		$statement = $pdo->prepare("INSERT INTO tbl_region (region_name) VALUES (?)");
		$statement->execute(array($_POST['region_name']));
