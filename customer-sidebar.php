<div class="user-sidebar">
    <ul>
        ...
        <a href="customer-billing-shipping-update.php"><button class="btn btn-danger">Update Billing and Shipping
                Info</button></a>
        <a href="customer-password-update.php"><button class="btn btn-danger">Update Password></button></a>
        <a href="customer-order.php"><button class="btn btn-danger">Order History</button></a>
